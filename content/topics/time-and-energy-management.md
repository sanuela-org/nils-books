...
- Energy and time bandwidth is real and limited. More connections can mean that the same energy is spread thinner.
- Evaluating your own capacity before saying yes prevents overextension and the resentment that follows.
- Scheduling conflicts are inevitable. They are not personal rejections. Treating them as such poisons the relationship network.
...
- The [[planning-pause|planning pause]] is one concrete technique for this — a brief check-in before committing to any plan that involves shared time.
...
- The [[reconnection-ritual|reconnection ritual]] bridges this gap. It communicates without words: *You left. You came back. I am still here. We are still we.*
